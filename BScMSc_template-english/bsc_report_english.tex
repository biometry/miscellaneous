...
\usepackage{mathptmx}  % Times New Roman with appropriately adapted numbers and symbols
					   % for the math environment; use for any kind of Times-like main font
